   ...
   static function helpHeader($title, $url='') {
     ...
     echo "<body class='$body_class'>";
      ...
      if (Session::haveRight("ticket", CREATE)) {
         ...
         $menu['create_ticket']['title']   = __s('Registrar un incidente');
...
//   }
   ...
   static function getCopyrightMessage() {
      ...
      $message .="' title=\"SaludPol\" class=\"copyright\">";
      $message .= "SALUDPOL "." Copyright (C) 2017-" . GLPI_YEAR . " - Fondo de Aseguramiento en Salud de la Policia Nacional del Perú "."</a>";
      return $message;
    }
